    ...
    if resource.save
      if resource.active_for_authentication?
        ...
        respond_to do |format|
          ...
          format.json { render status: :unprocessable_entity, json: { success: false, error_message: resource.error } }
        end
      end
    else
  ...
  def update
    ...
    if @user.update_attributes(params[:user])
      ...
      respond_to do |format|
        ...
        format.json { render status: :unprocessable_entity, json: { success: false, error_message: @user.error } }
      end
    end
  end
end
