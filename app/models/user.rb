class User < ActiveRecord::Base
  ...
  validates_uniqueness_of :class_no, :allow_nil => true, :allow_blank => true
  validates_uniqueness_of :qq, :allow_nil => true, :allow_blank => true
  ...
  def generate_class_no
    if self.class_no.blank?
      record = true
      while record
